...
\section{references}
\label{sec:orgd33b231}
You can add references to other sections, like section \ref{sec:org98691de}.

\section{Images}
\label{sec:orgd614044}
You can insert image, for example see image \ref{fig:orgaafc9aa}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:orgaafc9aa}
Example image.}
\end{figure}

\section{source code}
\label{sec:orgc8f2705}
Some c code:
