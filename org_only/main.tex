...
\section{references}
\label{sec:orga11d9c0}
You can add references to other sections, like section \ref{sec:org3460e54}.

\section{Images}
\label{sec:org0febc98}
You can insert image, for example see image \ref{fig:org9f1ccc0}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:org9f1ccc0}
Example image.}
\end{figure}

\section{source code}
\label{sec:orgdd9fd11}
Some c code:
