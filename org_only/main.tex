...
\section{references}
\label{sec:orga9ee2aa}
You can add references to other sections, like section \ref{sec:org104f923}.

\section{Images}
\label{sec:org9272c89}
You can insert image, for example see image \ref{fig:orge0d52d0}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:orge0d52d0}
Example image.}
\end{figure}

\section{source code}
\label{sec:orgd20ea11}
Some c code:
