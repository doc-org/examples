...
\section{references}
\label{sec:orgf96ae9a}
You can add references to other sections, like section \ref{sec:org073630f}.

\section{Images}
\label{sec:org28a3de6}
You can insert image, for example see image \ref{fig:orgcb95df1}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:orgcb95df1}
Example image.}
\end{figure}

\section{source code}
\label{sec:org1f2af30}
Some c code:
