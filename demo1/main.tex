...
\section{Images}
\label{sec:org080570f}
You can insert image, for example see image \ref{fig:orgc045923}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:orgc045923}
Example image.}
\end{figure}

\subsection{image matrix}
\label{sec:org22b72bd}
