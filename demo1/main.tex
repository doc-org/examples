...
\section{Images}
\label{sec:org57688f9}
You can insert image, for example see image \ref{fig:org07b53ac}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:org07b53ac}
Example image.}
\end{figure}

\subsection{image matrix}
\label{sec:orge641f85}
