...
\section{Images}
\label{sec:orgb2d729b}
You can insert image, for example see image \ref{fig:orga8055f1}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:orga8055f1}
Example image.}
\end{figure}

\subsection{image matrix}
\label{sec:orga667257}
