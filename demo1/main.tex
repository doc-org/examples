...
\section{Images}
\label{sec:orgd41e5fe}
You can insert image, for example see image \ref{fig:orgfa4b6b5}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:orgfa4b6b5}
Example image.}
\end{figure}

\subsection{image matrix}
\label{sec:orgc651f97}
