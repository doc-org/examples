...
\section{Images}
\label{sec:org27a9c8c}
You can insert image, for example see image \ref{fig:org16e1706}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:org16e1706}
Example image.}
\end{figure}

\subsection{image matrix}
\label{sec:orgd7ae9c4}
