...
\section{Images}
\label{sec:orgd03921a}
You can insert image, for example see image \ref{fig:org4d2a823}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:org4d2a823}
Example image.}
\end{figure}

\subsection{image matrix}
\label{sec:org0e077da}
