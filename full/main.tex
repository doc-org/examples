...
\section{Some math}
\label{sec:org1a46fbf}
You can insert latex equation, like equation \ref{eq:org152fdee}.
\begin{equation}
\label{eq:org152fdee}
\phi = \frac{2\pi fD}{c}
\end{equation}
\subsection{Other latex equations}
\label{sec:orgd0a40d0}
Equation \ref{eq:orgb5ce237} reference.
...
\section{Images}
\label{sec:org52a5524}
You can insert image, for example see image \ref{fig:org7e166f6}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:org7e166f6}
Example image.}
\end{figure}

\subsection{image matrix}
\label{sec:org249960d}
