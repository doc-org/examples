...
\section{Some math}
\label{sec:org49a38d1}
You can insert latex equation, like equation \ref{eq:orgf34553a}.
\begin{equation}
\label{eq:orgf34553a}
\phi = \frac{2\pi fD}{c}
\end{equation}
\subsection{Other latex equations}
\label{sec:org3b80541}
Equation \ref{eq:orgea549b4} reference.
...
\section{Images}
\label{sec:org93081e9}
You can insert image, for example see image \ref{fig:org9a4baab}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:org9a4baab}
Example image.}
\end{figure}

\subsection{image matrix}
\label{sec:org314f2d3}
