...
\section{Some math}
\label{sec:orgbe972de}
You can insert latex equation, like equation \ref{eq:org611e589}.
\begin{equation}
\label{eq:org611e589}
\phi = \frac{2\pi fD}{c}
\end{equation}
\subsection{Other latex equations}
\label{sec:org78c7bc5}
Equation \ref{eq:orge3c6373} reference.
...
\section{Images}
\label{sec:org54d812a}
You can insert image, for example see image \ref{fig:org9d007c2}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:org9d007c2}
Example image.}
\end{figure}

\subsection{image matrix}
\label{sec:org07f0131}
