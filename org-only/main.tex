...
\section{references}
\label{sec:org35b1f10}
You can add references to other sections, like section \ref{sec:orgfb51e67}.

\section{Images}
\label{sec:orgf99e757}
You can insert image, for example see image \ref{fig:orgb1ac0f2}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:orgb1ac0f2}
Example image.}
\end{figure}
\end{document}
