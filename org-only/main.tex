...
\section{references}
\label{sec:org654a81c}
You can add references to other sections, like section \ref{sec:org4b83722}.

\section{Images}
\label{sec:org0516773}
You can insert image, for example see image \ref{fig:orgf4d832d}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:orgf4d832d}
Example image.}
\end{figure}
\end{document}
