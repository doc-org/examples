...
\section{references}
\label{sec:org061c6b4}
You can add references to other sections, like section \ref{sec:org1b1d157}.

\section{Images}
\label{sec:org4221ce7}
You can insert image, for example see image \ref{fig:org04b4965}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:org04b4965}
Example image.}
\end{figure}
\end{document}
