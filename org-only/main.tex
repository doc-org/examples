...
\section{references}
\label{sec:org228ef66}
You can add references to other sections, like section \ref{sec:org24af853}.

\section{Images}
\label{sec:org2f2ca64}
You can insert image, for example see image \ref{fig:orge90b6fe}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./img/example_image.png}
\caption{\label{fig:orge90b6fe}
Example image.}
\end{figure}
\end{document}
