...
\label{sec:org8775faa}
This example shows what you can do with a one line \texttt{header.tex} file.

\subsection{subsection}
\label{sec:org4effbdb}
This text is a inside subsection. You can refer to other sections, like section \ref{sec:org8775faa}.
