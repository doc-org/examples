...
\label{sec:org6a6a5e2}
This example shows what you can do with a one line \texttt{header.tex} file.

\subsection{subsection}
\label{sec:orgeaf7232}
This text is a inside subsection. You can refer to other sections, like section \ref{sec:org6a6a5e2}.

\section{some code}
\label{sec:orgaf8f8ab}
