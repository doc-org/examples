...
\label{sec:org9733d73}
This example shows what you can do with a one line \texttt{header.tex} file.

\subsection{subsection}
\label{sec:org0206668}
This text is a inside subsection. You can refer to other sections, like section \ref{sec:org9733d73}.
