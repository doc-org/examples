...
\label{sec:org1b06ea7}
This example shows what you can do with a one line \texttt{header.tex} file.

\subsection{subsection}
\label{sec:orge9d2da9}
This text is a inside subsection. You can refer to other sections, like section \ref{sec:org1b06ea7}.
