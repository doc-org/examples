...
\label{sec:org311aa06}
This example shows what you can do with a one line \texttt{header.tex} file.

\subsection{subsection}
\label{sec:orga009bfc}
This text is a inside subsection. You can refer to other sections, like section \ref{sec:org311aa06}.
